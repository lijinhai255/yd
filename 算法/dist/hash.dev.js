...
function put(data) {
  var pos = this.simpleHash(data); // var pos = this.betterHash(data)
  // this.table[pos] = data;

  var ind = 0; // if(this.table[pos]&&this.table[pos][ind]==undefined){
...
function get(key) {
  ...
  for (var index = hash; index < this.table.length; index++) {
